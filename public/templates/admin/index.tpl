...
<div class="jumbotron">
	...
	<p><small>正在运行 <strong>NodeBB v{version}</strong>. 请保持 <strong>NodeBB</strong> 为最新版本。</small></p>
</div>


<div class="">
	<h2>活跃用户 <small><span class="badge" id="connections"></span> socket 连接</small></h2>
	<p id="active_users">
